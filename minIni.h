...
public:
	...
	int geti(const std::string& Section, const std::string& Key, int DefValue =
			0) const {
	...
	bool put(const std::string& Section, const std::string& Key, long Value) {
		return ini_putl(Section.c_str(), Key.c_str(), Value,
				iniFilename.c_str()) != 0;
	}
	...
	bool put(const std::string& Section, const std::string& Key,
			const char* Value) {
		return ini_puts(Section.c_str(), Key.c_str(), Value,
				iniFilename.c_str()) != 0;
	}
	...
	bool put(const std::string& Section, const std::string& Key,
			INI_REAL Value) {
		return ini_putf(Section.c_str(), Key.c_str(), Value,
				iniFilename.c_str()) != 0;
	}
#endif
